...
<sec:authorize access="isAnonymous()">
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel-body">
            ...
            <form data-toggle="validator" action="${pageContext.request.contextPath}/login/authenticate" method="POST" role="form">
                <!-- Add CSRF token -->
                ...
                <div class="row">
                    <div id="form-group-email" class="form-group col-lg-4">
                        ...
                        <input id="user-email" name="username" type="email" class="form-control"/>
                    </div>
                </div>
    ...
    <!-- Social Sign In Buttons -->
        ...
        <div class="panel-body">
            ...
            <div class="row social-button-row">
                <div class="col-lg-4">
                    <!-- Add Twitter sign in Button -->
                    <a href="<c:url value="/auth/linkedin"/>"><button class="btn btn-linkedin"><i class="icon-linkedin"></i> | <spring:message code="label.linkedin.sign.in.button"/></button></a>
                </div>
            </div>
        </div>
    </div>
